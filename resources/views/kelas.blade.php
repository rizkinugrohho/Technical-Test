...
<section id="services" class="services section">
    ...
    <!-- Section Title -->
    <div class="container-fluid bg-3 text-center" data-aos="fade-up">
        <h1 class="display-6 fw-bolder text-black">Lebih dari 2000+ Learning Video</h1>
        <p class="pcontent">Kami juga sudah menyediakan banyak pelatihan yang beragam, pelatihan disusun dan dibuat oleh tim kurikulum<br>
